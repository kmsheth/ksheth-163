...
DROP TYPE IF EXISTS cont;
CREATE TYPE cont AS ENUM ('Africa','Antarctica','Asia','Europe','North America','Oceania','South America');

CREATE TABLE countries (
  Code char(3) NOT NULL DEFAULT '',
  Name char(52) NOT NULL DEFAULT '',
  Continent cont NOT NULL DEFAULT 'Asia',
  Region char(26) NOT NULL DEFAULT '',
  SurfaceArea float(10) NOT NULL DEFAULT '0.00',
  IndepYear smallint DEFAULT NULL,
  Population int NOT NULL DEFAULT '0',
  LifeExpectancy float(3) DEFAULT NULL,
  GNP float(10) DEFAULT NULL,
  GNPOld float(10) DEFAULT NULL,
...
CREATE INDEX CitiesCountryCode ON cities (CountryCode); 

INSERT INTO cities (ID, Name, CountryCode, District, Population)
...
DROP TYPE IF EXISTS truefalse;
CREATE TYPE truefalse AS ENUM ('T', 'F');

CREATE TABLE languages (
  CountryCode char(3) NOT NULL DEFAULT '',
  Language char(30) NOT NULL DEFAULT '',
  IsOfficial truefalse NOT NULL DEFAULT 'F',
  Percentage double precision NOT NULL DEFAULT '0.0',
  CONSTRAINT languages_ibfk_1 FOREIGN KEY (CountryCode) REFERENCES countries (Code),
  PRIMARY KEY (CountryCode,Language)
);

CREATE INDEX LangCountryCode ON languages (CountryCode);

INSERT INTO languages (CountryCode, Language, IsOfficial, Percentage) 
